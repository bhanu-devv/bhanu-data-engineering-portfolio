...
| Sections (in locked page order) | **Built:** Hero with ProofStrip band (Phase 4); About, Experience (Phase 5); Projects (Phase 6); Skills, Certifications, Education (Phase 7). **Not built:** LeadershipAwards, Recommendations, GithubLinks, ResumeSection, Contact (Phase 7.5+) | Each renders nothing if its data is empty; order comes from `content/navigation.ts` |
...
| **7.5** | Leadership & Awards, Recommendations, GitHub / Links | Leadership & Awards, Recommendations (**hidden until approved records exist**), GitHub / Links (**profile and LinkedIn links only**; featured-repo block hidden) | Each section self-hides when empty; no placeholders anywhere; no invented URLs |
